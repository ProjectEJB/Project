            ...
            <section id="main-content">
                <section class="wrapper">
                    <header>
                        <div class="row">
                            <div class="col-md-6">
                                <h3> Thêm Hóa Phiếu Thanh Toán Tiền</h3>
                            </div>
                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" method="get">
                                    <div class="form-inline" role="form">
                                        <div class="row">
                                            <label class="col-md-4 col-md-offset-1 control-label" for="productName">Mã Chuyển Tiền</label>
                                            <div class="form-group col-sm-6">
                                                <input type="text" class="form-control" name="productName" id="txtpaymentNo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline" role="form">
                                        <div class="row">
                                            <label class="col-md-4 col-md-offset-1 control-label" for="price">Ngày Chuyển Tiền</label>
                                            <div class="form-group col-sm-6">
                                                <input type="date" class="form-control" 
                                                       name="price" id="txtpaymentDate">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline" role="form">
                                        <div class="row">
                                            <label class="col-md-4 col-md-offset-1 control-label" for="nation">Tổng Số Tiền</label>
                                            <div class="form-group col-sm-6">
                                                <input type="number" class="form-control" min="1" max="1000000" placeholder=".000 VNĐ"
                                                       name="price" id="txtpaymentAmt">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline" role="form">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                <textarea type="text" class="form-control" name="description" id="txtdescription"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="btnAdd">Thêm Phiếu Thanh Toán</button>
                                </div>
