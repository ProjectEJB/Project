                            ...
                            <div class="form-group">
                                <h3>
                                    <ul class="nav pull-right ">
                                        <li><a class="logout" href="addSalesOrder.jsp">Thêm Hóa Đơn Bán Hàng</a></li>
                                    </ul>
                                </h3>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="productModalTitle">Thêm Hóa Đơn Bán Hàng</h4>
                                    </div>
...
<script src="<c:url value="resources/js/myjs/SaleOrder.js" />"></script>
</html>
